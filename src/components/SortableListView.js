//Adapted from https://github.com/deanmcpherson/react-native-sortable-listview
...
class Row extends React.Component {
  ...
  render() {
    ...
    if (this.props.renderRow(this.props.rowData.data, this.props.rowData.section, this.props.rowData.index, null,this.props.active) == undefined) {
      return null;
    }
...
export default class SortableListView extends React.Component {
